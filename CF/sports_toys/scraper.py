"""
Sports & Toys Scraper - Cloudflare R2 Version
Scrapes https://www.sheeel.com/ar/sports-toys.html and all subcategories
...
class SportsToysScraper:
    def __init__(self, r2_bucket=None, cf_access_key=None, cf_secret_key=None, cf_endpoint_url=None, max_concurrent_subcategories=3):
        self.base_url = "https://www.sheeel.com/ar/sports-toys.html"
        self.category = "sports_toys"
        self.subcategories = {}
        self.all_products = []
    ...
    async def get_subcategories(self, page):
        ...
        try:
            ...
            for elem in subcategory_elements:
                ...
                if url and name and '/ar/sports-toys/' in url:
                    slug = url.split('/')[-1].replace('.html', '')
                    if slug and slug not in seen_slugs:
                        seen_slugs.add(slug)
                        subcategories.append({'name': name, 'url': url, 'slug': slug})
    ...
    async def scrape_all_subcategories(self):
        print("\n" + "="*70)
        print("🚀 SPORTS & TOYS SCRAPER - CONCURRENT SUBCATEGORIES")
        print("="*70)
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                for result in results:
                    ...
                    self.subcategories[slug] = {'name': name, 'products': products}
    ...
    def save_to_excel(self, include_r2_paths=False):
        ...
        filename = f"sports_toys_{timestamp}.xlsx"
    ...
    def upload_results_to_r2(self):
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"sports_toys_{timestamp}.xlsx"
    ...
    def run(self):
        print("\n" + "="*70)
        print("🏀 SPORTS & TOYS SCRAPER - CLOUDFLARE R2")
        print("="*70)
