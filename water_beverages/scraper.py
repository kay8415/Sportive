"""
Water & Beverages Scraper - Complete Production Version
Scrapes https://www.sheeel.com/ar/water-beverages.html with pagination
...
class WaterBeveragesScraper:
    def __init__(self, s3_bucket=None, aws_access_key=None, aws_secret_key=None):
        self.base_url = "https://www.sheeel.com/ar/water-beverages.html"
        self.category = "water_beverages"
        self.products = []
    ...
    def scrape_all_pages(self):
        ...
        print("\n" + "="*70)
        print("🚀 WATER & BEVERAGES SCRAPER - WITH PAGINATION")
        print("="*70)
        print(f"\nURL: {self.base_url}\n")
    ...
    def save_to_excel(self, include_s3_paths=False):
        ...
        filename = f"water_beverages_{timestamp}.xlsx"
    ...
    def upload_results_to_s3(self):
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"water_beverages_{timestamp}.xlsx"
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("💧 WATER & BEVERAGES SCRAPER - PRODUCTION")
        print("="*70)
