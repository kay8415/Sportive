"""
Under 5 KWD Scraper - Complete Production Version
Scrapes https://www.sheeel.com/ar/under-5.html with pagination
...
class Under5Scraper:
    def __init__(self, s3_bucket=None, aws_access_key=None, aws_secret_key=None):
        self.base_url = "https://www.sheeel.com/ar/under-5.html"
        self.category = "under_5"
        self.products = []
    ...
    def scrape_product_detail(self, context, product_url, index):
        ...
        try:
            ...
            # Features / specs / box contents / warranty from #more-info
    ...
    def scrape_all_pages(self):
        ...
        print("\n" + "="*70)
        print("🚀 UNDER 5 KWD SCRAPER - WITH PAGINATION")
        print("="*70)
        print(f"\nURL: {self.base_url}\n")
    ...
    def save_to_excel(self, include_s3_paths=False):
        ...
        filename = f"under_5_{timestamp}.xlsx"
    ...
    def upload_results_to_s3(self):
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"under_5_{timestamp}.xlsx"
    ...
    def run(self):
        """Main execution flow"""
        print("\n" + "="*70)
        print("💰 UNDER 5 KWD SCRAPER - PRODUCTION")
        print("="*70)
